...
<section>
  ...
  <p>Design inspirtion came from command line interface, in reference to the use of artificial intelligence, built using reusable components for consistency and scalability. WCAG 2.1 AA compliant from day one, influenced by GOV.UK design principles.</p>
</section>
