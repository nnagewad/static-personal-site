...
---
<section>
  <h2 class="font-size-2">Context</h2>
...
<section>
  <h2 class="font-size-2">Design judgment</h2>
...
<section>
  <h2 class="font-size-2">Design decisions</h2>
  <h3 class="font-size-1">Automation first</h3>
  ...
  <h3 class="font-size-1">AI with guardrails</h3>
  ...
  <h3 class="font-size-1">Full ownership</h3>
  <p>Everything—images, metadata, infrastructure—stays under my control. No platform lock-in.</p>
  
  <h3 class="font-size-1">Multi-channel distribution</h3>
  ...
  <h3 class="font-size-1">Scalable and accessible design system</h3>
...
<section>
  <h2 class="font-size-2">Impact</h2>
  <ul>
...
<section>
  <h2 class="font-size-2">What I learned</h2>
