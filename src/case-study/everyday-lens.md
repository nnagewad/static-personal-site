...
<section>
  ...
  <p>Terminal-inspired UI, typography, and color scheme, built using reusable components for consistency and scalability. WCAG 2.1 AA compliant from day one, influenced by GOV.UK design principles.</p>
</section>
